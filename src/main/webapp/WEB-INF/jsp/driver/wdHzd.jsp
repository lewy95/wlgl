...
<table width="800px" align="center" class="table table-striped table-bordered table-hover table-condensed">
    ...
    <tbody>
    <s:iterator value="#driverHzs" status="i">
        <tr>
            ...
            <td>
                <s:if test='Execute == "0" && BackBillState == "1"'>
                    <button type="button" class="btn btn-warning">车辆未出</button>
                </s:if>
                <s:if test='Execute == "1" && BackBillState == "1"'>
                    <button type="button" class="btn btn-primary">车辆未到</button>
                </s:if>
            </td>
            <td>
                <s:if test='Execute == "1" && BackBillState == "1"'>
                    <a href="driverHzInput?id=<s:property value="id"/>">填写回执单</a>
                </s:if>
            </td>
            </s:if>
        </tr>
